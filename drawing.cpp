...
Drawing::Drawing(int size)
    :MaeChart(size,size),bg_color{Qt::white},brush_color{Qt::black},pen_color{Qt::black},thickness{3}
{
...
void Drawing::drawLegend(int font_size)
{
    ...
    painter.drawText(triSpaceUp,Qt::AlignCenter, QString::number( round(Values[0].value*10000.0)/10000.0));
